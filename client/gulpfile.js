...
function build () {
return runSequence ("limpaBuild","copiaImagens", "copiaIndex", "geraCss", "concatenaJs", "jsHint", "insereCssJs", "geraSvgSprite", "insereSvgSprite", "copiaPaginasHtml", "excluiArquivosTemporarios")
}
...
gulp.src("./images/placeholder/*.*").pipe(gulp.dest("./build/images/placeholder"))
gulp.src("./images/favicon/*.*").pipe(gulp.dest("./build/images/favicon"))
gulp.src("./images/logos/*.*").pipe(gulp.dest("./build/images/logos"))
}
